...
model = joblib.load(r'C:\Users\Joseph\Desktop\cardheko cleaned data\car_price_prediction_model.pkl')
...
data = pd.read_csv(r'C:\Users\Joseph\Desktop\cardheko cleaned data\car_dekho_cleaned_dataset_Raw.csv')
...
# Set the background image (ensure the path is correct and the image exists)
image_path = r'C:\Users\Joseph\Desktop\car image.jpg'
...
st.markdown("""
    ...
    .result-container {
        text-align: center;
        background-color: rgba(255, 255, 255, 0.7);  /* Increased transparency and white background */
        padding: 20px;
        border-radius: 10px;
    }
    .prediction-title {
        font-size: 32px;
        color: black;  /* Black font color for Predicted Car Price */
    }
    .prediction-value {
        font-size: 40px;
        font-weight: bold;
    ...
    .info {
        font-size: 18px;
        color: black;  /* Black font color for Car Age and Efficiency Score with no transparency */
        background-color: transparent;  /* No transparency for the font */
    }
